    ...
    <article>
      {propiedades.map((propiedad, index) => (
        <Link
          ...
          className=""
        >
          <div className="md:w-[420px] w-96 bg-white border border-gray-200 rounded-lg shadow-2xl shadow-black/20 scale-75 ">
            ...
            <div className="p-5">
              ...
              <div className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-black/80 bg-[#a1d1cf] rounded-lg hover:bg-blue-300 transition duration-300 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-[#a1d1cf]dark:hover:bg-blue-700 dark:focus:ring-blue-500">
                Consultar
                <svg
