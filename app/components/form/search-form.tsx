...
function SearchForm(): JSX.Element {
  ...
  return (
    <form className="flex gap-4 w-auto bg-white justify-between flex-col md:flex-row border rounded-2xl px-4 py-2 shadow-md hover:-translate-y-1 transition duration-300 hover:shadow-xl ">
